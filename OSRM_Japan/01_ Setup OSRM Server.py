...
# MAGIC 
# MAGIC アジアのファイル: [Geofabrik Download Server](https://download.geofabrik.de/asia.html)
# MAGIC 
...
# MAGIC 
# MAGIC **注意** このステップは日本の地図ファイルの場合は5分程度必要とします。
...
# MAGIC rm -rf /srv/git/osrm-backend/maps/japan
# MAGIC mkdir -p /srv/git/osrm-backend/maps/japan
# MAGIC 
# MAGIC # download map file to appropriate folder
# MAGIC cd /srv/git/osrm-backend/maps/japan
# MAGIC wget --quiet https://download.geofabrik.de/asia/japan-latest.osm.pbf
# MAGIC 
...
# MAGIC 
# MAGIC **注意** このステップは日本地図ファイルの場合10分程度必要とします。
...
# MAGIC /srv/git/osrm-backend/build/osrm-extract japan-latest.osm.pbf -p /srv/git/osrm-backend/profiles/car.lua > /srv/git/osrm-backend/logs/extract_log.txt
# MAGIC 
...
# MAGIC %sh -e ls -l /srv/git/osrm-backend/maps/japan
...
# MAGIC 
# MAGIC **注意** このステップは日本地図ファイルの場合、5分程度要します。
...
# MAGIC cd /srv/git/osrm-backend/maps/japan
# MAGIC 
# MAGIC /srv/git/osrm-backend/build/osrm-partition japan-latest.osrm
...
# MAGIC cd /srv/git/osrm-backend/maps/japan
# MAGIC 
# MAGIC /srv/git/osrm-backend/build/osrm-customize japan-latest.osrm
...
# MAGIC %sh -e
# MAGIC 
# MAGIC rm -rf /dbfs/FileStore/osrm-backend-japan
# MAGIC cp -L -R /srv/git/osrm-backend /dbfs/FileStore/osrm-backend-japan
