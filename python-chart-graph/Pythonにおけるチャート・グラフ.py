...
# MAGIC - データを分割する方法を**Series groupings**で指定します。棒グラフにおいては、それぞれの系列グルーピングには異なる色と、それぞれの系列グルーピングを示す凡例が与えられます。多くのグラフタイプでは、10以下のユニークな値を持つ系列グルーぴいングのみを取り扱うことができます。
# MAGIC 
...
# MAGIC   - オリジナルの業を結合するための方法として**SUM**、**AVG**、**MIN**、**MAX**、**COUNT**を選択します。
