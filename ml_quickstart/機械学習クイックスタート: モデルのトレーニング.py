...
# MAGIC 
# MAGIC モデルのライフサイクル管理やモデルの推論などDatabricksにおける機械学習の本格運用に関しては、エンドツーエンドのサンプルをご覧ください。 ([AWS](https://docs.databricks.com/applications/mlflow/end-to-end-example.html)|[Azure](https://docs.microsoft.com/azure/databricks/applications/mlflow/end-to-end-example)).
# MAGIC 
# MAGIC ### 要件
# MAGIC 
...
# MAGIC ### ライブラリ
# MAGIC 
# MAGIC 必要なライブラリをインポートします。これらのライブラリはDatabricks機械学習ランタイム([AWS](https://docs.databricks.com/runtime/mlruntime.html)|[Azure](https://docs.microsoft.com/azure/databricks/runtime/mlruntime))にプレインストールされており、互換性とパフォーマンスに関してチューニングされています。
...
# MAGIC ### データのロード
# MAGIC 
# MAGIC このチュートリアルでは、異なるワインのサンプルからなるデータセットを使用します。この[データセット](https://archive.ics.uci.edu/ml/datasets/Wine)は、UCI Machine Learning Repositoryからのもので、DBFS ([AWS](https://docs.databricks.com/data/databricks-file-system.html)|[Azure](https://docs.microsoft.com/azure/databricks/data/databricks-file-system))に格納されています。ここでのゴールは、品質に基づいて赤ワイン・白ワインを分類するというものです。
# MAGIC 
...
# MAGIC 
# MAGIC 記録されたトレーニングランを参照するには、エクスペリメントサイドバーを表示するために、ノートブックの右上の**Experiment**アイコンをクリックします。必要であれば、最新の状態を表示するためにリフレッシュアイコンをクリックします。
# MAGIC 
# MAGIC <img width="350" src="https://docs.databricks.com/_static/images/mlflow/quickstart/experiment-sidebar-icons.png"/>
# MAGIC 
# MAGIC より詳細なMLflowエクスペリメントページ([AWS](https://docs.databricks.com/applications/mlflow/tracking.html#notebook-experiments)|[Azure](https://docs.microsoft.com/azure/databricks/applications/mlflow/tracking#notebook-experiments))を表示するために、エクスペリメントページアイコンをクリックすることができます。このページでは、ランを比較したり、特定のランの詳細を参照できます。
# MAGIC 
...
# MAGIC ### モデルのロード
# MAGIC 
# MAGIC MLflow APIを用いて特定のランの結果にアクセスすることもできます。以下のセルのコードでは、特定のMLflowランにおいてトレーニングされたモデルをロードして予測を行う方法を示しています。MLflowランページ([AWS](https://docs.databricks.com/applications/mlflow/tracking.html#view-notebook-experiment)|[Azure](https://docs.microsoft.com/azure/databricks/applications/mlflow/tracking#view-notebook-experiment))で特定のモデルをロードするためのコードスニペットを参照することもできます。
...
# MAGIC 
# MAGIC Part 1と同じように、**Experiment**サイドバーの上にある外部リンクアイコンからアクセスできるMLflowエクスペリメント詳細ページでランを参照、比較することができます。
# MAGIC 
# MAGIC エクスペリメント詳細ページで、親のランを展開するために"+"アイコンをクリックし、親以外の全てのランを選択、**Compare**をクリックします。それぞれのパラメーターのメトリックに対するインパクトを表示するparallel coordinates plotを用いて、異なるランを可視化することができます。
